...
2. Ensure you have `KynosLib.jar` installed as well. *(Note: KynosLib is required and can be downloaded from its own repository [HERE](https://github.com/KynosDeveloping/KynosLib/releases/tag/1.0.0)).*
